package com.israrxy.raazi.player.potoken
...
//        webViewSettings.safeBrowsingEnabled = false // sdk24 support
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun onConsoleMessage(m: ConsoleMessage): Boolean {
                if (m.message().contains("Uncaught")) {
                    ...
                    // indicates that that there was a syntax error in the code, i.e. the WebView only
    ...
    companion object {
        ...
        suspend fun getNewPoTokenGenerator(context: Context): PoTokenWebView {
            // Updated to be public to be accessible from PoTokenGenerator
            return withContext(Dispatchers.Main) {
                suspendCancellableCoroutine { cont ->
